...
**Epic Goal:** Enhance the user experience with a proper home page, persistent navigation, improved mobile menu visibility, and terminal-inspired visual styling that adds personality and interactivity to the portfolio.

**Value Delivered:** At the end of this epic, the portfolio has a professional landing page, consistent navigation across all views, better mobile usability, and distinctive terminal-inspired styling that makes the site memorable and engaging while maintaining professionalism.
...
## Story 3.2: Terminal-Style Visual Enhancements
