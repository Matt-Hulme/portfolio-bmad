...
- [ ] **Task 1: Install and Configure React Router** (AC: 1)
  ...
  - [ ] Configure routes: `/` (Home), `/resume`, `/contact`, `*` (404)
  - [ ] Update `main.tsx` to use BrowserRouter
  - [ ] Verify routing works with placeholder pages

- [ ] **Task 2: Create Page Components** (AC: 1, 7)
  - [ ] Create `src/pages/Home.tsx` placeholder
  - [ ] Create `src/pages/Resume.tsx` placeholder
  - [ ] Create `src/pages/Contact.tsx` placeholder
  - [ ] Create `src/pages/NotFound.tsx` (404 page)
  - [ ] Add basic content and styling to each page
  - [ ] Create unit tests for each page component

- [ ] **Task 3: Create Navigation Component** (AC: 2, 4, 8)
  - [ ] Create `src/components/layout/Navigation.tsx`
  - [ ] Add navigation links using React Router `Link` or `NavLink`
  - [ ] Implement active route indication (highlight current page)
  - [ ] Ensure keyboard navigation works (Tab, Enter)
  - [ ] Style navigation with Hacker Minimalist aesthetic
  - [ ] Create unit tests for Navigation component

- [ ] **Task 4: Implement Responsive Navigation** (AC: 3)
  - [ ] Install shadcn Sheet component for mobile drawer
  - [ ] Create mobile navigation with hamburger menu
  - [ ] Use Tailwind responsive breakpoints (mobile < md, desktop >= md)
  - [ ] Ensure mobile menu closes on route change
  - [ ] Add smooth open/close animations
  - [ ] Test navigation on mobile, tablet, desktop viewports

- [ ] **Task 5: Create Page Layout Component** (AC: 5)
  - [ ] Create `src/components/layout/PageLayout.tsx`
  - [ ] Add header with Navigation component
  - [ ] Add footer with copyright and links
  - [ ] Wrap layout around routes using `Outlet`
  - [ ] Ensure consistent spacing and max-width
  - [ ] Create unit tests for PageLayout

- [ ] **Task 6: Implement Smooth Route Transitions** (AC: 6)
  - [ ] Add Suspense boundary for lazy-loaded routes
  - [ ] Implement loading state for route transitions
  - [ ] Ensure no flash of unstyled content (FOUC)
  - [ ] Add fade-in animation for page changes (optional)
